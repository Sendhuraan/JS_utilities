...
//		'Mobile Safari 7.0.0 (iOS 7.1)'
	...
	namespace('browserTests', function() {
		...
		var karmaConfig = cfg.parseConfig(path.resolve('./build/config/karma.config.js'));
	...
	namespace('bundle', function() {
		...
		task('unit', function(sourceDirName) {
			...
			if(!sourceDirName) {
				...
				browserifyRunner.bundle(COLLATED_CLIENT_DIR + '/app.js', BROWSERIFY_DIR + '/bundle.js', complete, fail);
			}
